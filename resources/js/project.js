...
import * as Project from "./components/project/bundle.js?v_=2.5.8";
import * as ChildProject from "./components/project/child/bundle.js?v_=2.5.8";
    ...
    Alpine.data("saveChild", () => ({
        ...
        handleUpdate(u) {
            ...
            this.$dispatch('load-tasks', {
                ...
                taskId: this.$data.child.task_id
            });
